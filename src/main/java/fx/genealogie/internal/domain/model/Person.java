...
public class Person implements Comparable<Person> {
    ...
    public void addPhoto(BufferedWriter writer) throws IOException {
        writer.append("<a href='").append(getPhoto()).append("'>");
        writer.append("<img src='").append(getPhoto()).append("' class=\"photo\" title=\"").append(getName()).append("\" alt=\"").append(getLastName()).append(",").append(getFirstName()).append("\" />");
        writer.append("</a>");
    }
    ...
    public String getRealLastName() {
        if (this.lastName.startsWith("de ")) {
            ...
            return this.lastName.replace("�", "e").replace("�", "c");
        }
    }
    ...
    public String getRealFirstName() {
        if (this.firstName == null)
            return null;
        return this.firstName.replace("�", "e").replace("�", "c");
    }
